...
INSERT INTO ad (description, startLocation, endLocation, startDate, endDate, animals, smoker, notes, numSeats, userId, state)
VALUES ('Ja Beschreibung halt so lololol', 'City A', 'City B', '2023-01-10', '2023-01-15', 0, 1, 'No pets allowed', 4, 1, 'created'),
       ('Ja Beschreibung halt so lololol', 'Town X', 'Town Y', '2023-02-05', '2023-02-10', 1, 0, 'Smoking allowed', 2, 2, 'created'),
       ('Ja Beschreibung halt so lololol', 'City C', 'City D', '2024-03-24', '2024-03-25', 0, 0, NULL, 6, 1, 'created'),
       ('Beschreibung smth', 'Somestandt M', 'Somestadt N', '2098-03-20', '2098-03-25', 0, 0, 'No something allowed', 6, 1, 'created'),
        ('Beschreibungstext der etwas länger sein sollte blalala lbla lalshlw ashiw siwl w hil wdwi dhwlid hwid hwlidwh dliw dhw', 'Village M', 'Village N', '2023-03-20', '2023-03-25', 0, 0, NULL, 6, 2, 'started'),
      ('Ja Beschreibung halt so lololol', 'Village M', 'Village N', '2023-03-20', '2023-03-25', 0, 0, NULL, 6, 3, 'finished');
...
INSERT INTO booking (adId, userId, price, numSeats, canceled, state)
VALUES (1, 2, 200.0, 4, FALSE, 'pending'),
       (2, 3, 150.0, 2, TRUE, 'confirmed'),
       (3, 1, 240.0, 5, FALSE, 'denied');
